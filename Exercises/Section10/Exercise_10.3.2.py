# Exercise_10.3.2.py
# GaussianMM (spherical approach) clustering for the MNIST Digits Dataset
...
model.plot_objective(title="Gaussian MM Clustering",xlabel="Iteration",ylabel="Objective")
